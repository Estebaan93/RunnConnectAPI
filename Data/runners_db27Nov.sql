...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 27-11-2025 a las 14:40:16
...
(4, 6, 'TestRunner', 'Registro simple', NULL, NULL, NULL, NULL, NULL, NULL, NULL);
...
(6, 'TestRunner', 'runner@test.com', NULL, '$2a$12$n4Ew2QzwK1q5aWYfWEwTwOty2RfqxD1PPETnFzhLWpjpM3HB5ui0G', 'runner', 1, '/uploads/avatars/defaults/default_runner.png');
...
--
ALTER TABLE `perfiles_runners`
  MODIFY `idPerfilRunner` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
